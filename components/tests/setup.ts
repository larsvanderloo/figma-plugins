// components/tests/setup.ts — Vitest global setup for @figma-plugins/components tests.
//
// Owner: ui-engineer
//
// Node 25 localStorage shim.
// pinia@3 (a transitive dep) imports @vue/devtools-kit which calls
...
// --localstorage-file. This shim installs a no-op Map-backed store before any
// dynamic import that might pull in Pinia or devtools-kit.
