// sections/BadgeEditor/tests/setup.ts — Vitest global setup for BadgeEditor tests.
//
// Owner: ui-engineer
//
// Node 25 localStorage shim — same rationale as sections/SlidePicker/tests/setup.ts.
