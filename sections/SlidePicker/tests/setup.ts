// sections/SlidePicker/tests/setup.ts — Vitest global setup for SlidePicker tests.
//
// Owner: ui-engineer
//
// Node 25 localStorage shim — same rationale as plugins/welder-editor/tests/setup.ts.
