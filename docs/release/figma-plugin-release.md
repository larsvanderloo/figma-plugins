...
- fails when generated nested workspaces such as `src/ui/node_modules/` are present
...
- `manifest-cache/`
- debug log files
- nested generated workspaces such as `src/ui/node_modules/`
...
- Nested generated workspace: remove the reported directory, usually `src/ui/node_modules/`, and rerun `npm run workspace:assert`.
