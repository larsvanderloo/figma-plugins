...
//
// T52 — fit-discipline (harde invariant: nooit buiten de content-frame):
...
/**
 * T52 — single-line ellipsis op vaste breedte. maxLines=1 +
...
/**
 * T52 — breedte-budget per legenda-rij, in drie degradatie-stappen:
...
function fitRowToWidth(
  ...
  // Stap 1 — label single-line ellipsen binnen het rest-budget (T51.2).
...
/** T52 — korps + afgeleide maten (swatch, spacings) in één keer zetten,
...
export function buildLegend(
  ...
  // T52 — WRAP-modus alleen met een geldig breedte-budget (de wikkel
  ...
  for (let i = 0; i < entries.length; i++) {
    ...
    // T51.2/T52 — width-budget: lange labels (incl. waarde/delta-suffix)
  ...
  // T52 — hoogte-budget met degradatie-ladder (meet-dan-reserveer:
