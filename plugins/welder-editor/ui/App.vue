 ...
 * Sprint 5.15 consolidation (ADR-0015) — sections/* imports rewritten to
 * relative ./components/Component.vue siblings.
 *
 * Layout:
 *   <UApp>
...
import type { CardItem } from './components/types.js';
...
// ---------------------------------------------------------------------------
// ImageEditor — PR#59 interface: emits `upload` with Uint8Array
// ---------------------------------------------------------------------------
      ...
      <main class="flex-1 overflow-y-auto">
        <div class="mx-auto max-w-2xl space-y-3 p-3">
          ...
          <template v-else>
            ...
            <!-- Slide selected but no editable wrappers -->
            <section
              v-else-if="allEmpty"
              class="bg-default rounded-[calc(var(--ui-radius)*4)] px-5 py-8 shadow-[0_4px_16px_-6px_rgba(0,0,0,0.08)]"
            >
            ...
            >
              ...
              >
                <div class="px-5 py-6 space-y-4">
                  ...
                  <!--
                    ImageEditor (PR#59 interface):
                    - modelValue: { hasImage, imageHash }
                    - previewUrl: null in v0.1.0 (no preview fetch yet)
                    - fillW/fillH: null (unknown slot dimensions)
                    - @upload: raw Uint8Array bytes
                  -->
