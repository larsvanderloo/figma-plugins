 ...
 *
 * Lifted from sections/ImageEditor/src/CropperCanvas.vue.
 * Import paths updated from ./types.js and ./cropMath.js to the flat
 * ui/components/ equivalents.
 *
...
import type { Transform, CropRect, HandlePosition } from './imageEditorTypes.js';
...
// rAF handle — declared early so scheduleRedraw() can reference it
...
onUnmounted(() => {
  // cleanup done in onBeforeUnmount
});
</script>
